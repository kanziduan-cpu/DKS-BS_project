...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull Button loginButton,
      @NonNull TextInputEditText passwordEditText, @NonNull Button registerButton,
      @NonNull CheckBox rememberPasswordCheckBox, @NonNull TextInputEditText usernameEditText) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rememberPasswordCheckBox;
      CheckBox rememberPasswordCheckBox = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, loginButton, passwordEditText,
          registerButton, rememberPasswordCheckBox, usernameEditText);
    }
