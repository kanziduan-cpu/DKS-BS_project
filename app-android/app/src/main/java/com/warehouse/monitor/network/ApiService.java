...
public interface ApiService {
    String BASE_URL = ServerConfig.getBaseUrl() + "/api/";
    ...
    OkHttpClient client = new OkHttpClient.Builder()
            ...
            .addInterceptor(chain -> {
                ...
                Log.d("HttpInterceptor", "Sending request: " + request.url());
                Log.d("HttpInterceptor", "Request method: " + request.method());
                
                okhttp3.Response response = chain.proceed(request);
                long endTime = System.currentTimeMillis();
                
                Log.d("HttpInterceptor", "Received response: " + response.code() + " " + response.message());
                Log.d("HttpInterceptor", "Request duration: " + (endTime - startTime) + "ms");
    ...
    Call<Device> getDeviceStatus(@Path("deviceId") String deviceId);

        // Environment data endpoints
        @GET("environment/current")
        Call<EnvironmentData> getCurrentData(@Query("deviceId") String deviceId);
    ...
    @GET("alarm/unread")
    Call<Integer> getUnreadAlarmCount(@Query("deviceId") String deviceId);
