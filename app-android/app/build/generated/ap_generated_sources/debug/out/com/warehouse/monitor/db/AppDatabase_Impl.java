  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(3) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `devices` (`deviceId` TEXT NOT NULL, `name` TEXT, `type` TEXT, `status` TEXT, `isRunning` INTEGER NOT NULL, `warehouseId` TEXT, `servoAngle` INTEGER NOT NULL, PRIMARY KEY(`deviceId`))");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '1d8bc1002d2c0f26cdaeafb259b4f51a')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsDevices.put("servoAngle", new TableInfo.Column("servoAngle", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "1d8bc1002d2c0f26cdaeafb259b4f51a", "527a6fb833e4376f8b3a1f0d9078a1ca");
