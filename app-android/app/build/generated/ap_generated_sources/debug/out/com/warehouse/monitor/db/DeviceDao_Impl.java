...
public final class DeviceDao_Impl implements DeviceDao {
  ...
  public DeviceDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfDevice = new EntityInsertionAdapter<Device>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `devices` (`deviceId`,`name`,`type`,`status`,`isRunning`,`warehouseId`,`servoAngle`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Device value) {
        ...
        stmt.bindLong(7, value.getServoAngle());
      }
    };
    ...
    this.__updateAdapterOfDevice = new EntityDeletionOrUpdateAdapter<Device>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `devices` SET `deviceId` = ?,`name` = ?,`type` = ?,`status` = ?,`isRunning` = ?,`warehouseId` = ?,`servoAngle` = ? WHERE `deviceId` = ?";
      }
    ...
    return __db.getInvalidationTracker().createLiveData(new String[]{"devices"}, false, new Callable<List<Device>>() {
      ...
      public List<Device> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfServoAngle = CursorUtil.getColumnIndexOrThrow(_cursor, "servoAngle");
          ...
          while(_cursor.moveToNext()) {
            ...
            final int _tmpServoAngle;
            _tmpServoAngle = _cursor.getInt(_cursorIndexOfServoAngle);
            _item.setServoAngle(_tmpServoAngle);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Device getDeviceById(final String deviceId) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        final int _tmpServoAngle;
        _tmpServoAngle = _cursor.getInt(_cursorIndexOfServoAngle);
        _result.setServoAngle(_tmpServoAngle);
      } else {
        _result = null;
      }
      return _result;
  ...
  private String __DeviceType_enumToString(final Device.DeviceType _value) {
    if (_value == null) {
      ...
      case WINDOW_ACTUATOR: return "WINDOW_ACTUATOR";
      case FAN_ACTUATOR: return "FAN_ACTUATOR";
  ...
  private Device.DeviceType __DeviceType_stringToEnum(final String _value) {
    if (_value == null) {
      ...
      case "WINDOW_ACTUATOR": return Device.DeviceType.WINDOW_ACTUATOR;
      case "FAN_ACTUATOR": return Device.DeviceType.FAN_ACTUATOR;
