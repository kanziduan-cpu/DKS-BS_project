...
//MPU6050_INT
#define MPU6050_INT_GPIO_PORT          GPIOB                           /* GPIO端口 */
#define MPU6050_INT_GPIO_CLK_PORT      RCC_APB2Periph_GPIOB            /* GPIO端口时钟 */
#define MPU6050_INT_GPIO_PIN           GPIO_Pin_8                      /* 对应PIN脚 */

#define MPU6050_INT_EXTI_PORTSOURCE    GPIO_PortSourceGPIOB            /* 中断端口源 */
#define MPU6050_INT_EXTI_PINSOURCE     GPIO_PinSource8                 /* 中断PIN源 */
#define MPU6050_INT_EXTI_LINE          EXTI_Line8                      /* 中断线 */
#define MPU6050_INT_EXTI_IRQ           EXTI9_5_IRQn                    /* 外部中断向量号 */
#define MPU6050_INT_EXTI_IRQHANDLER    EXTI9_5_IRQHandler              /* 中断处理函数 */
...
/* 震动检测相关定义和函数 */
typedef enum {
    SHAKE_STABLE = 0,      /* 稳定状态，无震动 */
    SHAKE_MILD = 1,        /* 轻微震动 */
    SHAKE_MODERATE = 2,    /* 中等震动 */
    SHAKE_SEVERE = 3       /* 严重震动 */
} Shake_Severity_TypeDef;
